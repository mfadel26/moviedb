...
function Homes() {
	...
	return (
		...
		<div className={"movieContainer"}>
			...
			<div className="metadata">
				...
				<div className="infoContainer">
					...
					<div className="info">
						<h4>Running Time</h4>
						<p>{data.runtime === 0 || !data.runtime ? "N/A" : `${data.runtime} mins`}</p>
					</div>
					<div className="info">
						<h4>Budget</h4>
		...
		<div className="movieContainer"><p  style={{padding:5,fontSize:18,fontWeight:"bold"}}>You Might Also Like This!</p></div>
		<div
		className="similar"
				style={{
					color: "#000000",
